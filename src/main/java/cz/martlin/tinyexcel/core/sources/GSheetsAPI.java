...
import cz.martlin.sheets2csv.TestAppv2;
...
public class GSheetsAPI {
	...
	private static Credential getCredentials(
		...
		// Load client secrets.
		InputStream in = TestAppv2.class
	...
	public Sheets obtainService(String spreadsheetId) throws IOException {
		try {
			...
			throw new IOException("Cannot obtain gsheets service", e);
		}
	}
}
